    ...
    commands: {
      ...
      [config.commandList.command3]: {
        ...
        messages: {
          ...
          "auto-initialize-success": "{0} 自动初始化成功！你的武器初始长度为 {1} cm。初始生长系数为：{2}",
          ...
          "exercise-success": "{0} 锻炼成功！武器强化后长度为 {1} cm。",
          "exercise-failure": "{0} 锻炼失败！武器强化后长度为 {1} cm。",
        },
      },
      ...
      [config.commandList.command5]: {
        description: "重开一个武器~",
        messages: {
          "reset-success": "武器重置成功，当前长度为 {0} cm，成长系数为 {1}。",
          "initialize-success": "武器初始化成功，当前长度为 {0} cm，成长系数为 {1}。",
        },
      },
      ...
      [config.commandList.command7]: {
        description: "查看武器排行榜",
        messages: {
          "leaderboard-text": "武器排行榜：\n{0}",
        },
      },
      [config.commandList.command8]: {
        description: "查看武器",
        messages: {
          "user-not-initialized": "暂时没有{0} 的记录。快输入【生成武器】进行初始化吧",
          "user-info": "{0} 的武器长度为 {1} cm，成长系数为 {2} 。<p>剩余点数为：{3}",
        },
      },
      [config.commandList.command9]: {
        description: "开启/禁止武器大作战",
        messages: {
          "permission-denied": "你没有权限执行此操作。",
          "user-locked": "用户 {0} 已被禁止触发武器大作战。",
          "user-unlocked": "用户 {0} 已可以触发武器大作战。",
          "channel-locked": "武器大作战已在本频道被禁止。",
          "channel-unlocked": "武器大作战已在本频道开启。",
        },
      }
    }
  });
